...
router.get('/user/:id', async (req, res) => {
    ...
    // También se puede obtener un usuario por su correo electrónico.
    // Este código está comentado y no se utiliza en este momento.
    // Se puede descomentar si se desea habilitar esta funcionalidad.
